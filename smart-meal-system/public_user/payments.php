...
<div class="section-title">
  ...
  <p class="text-muted">As a General Public user, your meals are billed <strong>weekly</strong>. The bill for the current week
      ...
      <tr>
        ...
        <td>
          <?php if ($p['status'] === 'pending' || $p['status'] === 'overdue'): ?>
            <a href="<?= BASE_URL ?>/public_user/pay.php?payment_id=<?= $p['payment_id'] ?>" class="btn btn-sm">Pay Now</a>
          <?php else: ?>
