...
<div class="section-title">
  ...
  <p class="text-muted">As a Student, your meals are billed <strong>monthly</strong>. The bill for the current month
      ...
      <tr>
        ...
        <td>
          <?php if ($p['status'] === 'pending' || $p['status'] === 'overdue'): ?>
            <a href="<?= BASE_URL ?>/student/pay.php?payment_id=<?= $p['payment_id'] ?>" class="btn btn-sm">Pay Now</a>
          <?php else: ?>
