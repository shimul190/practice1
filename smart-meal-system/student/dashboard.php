...
<div class="flex-between section-title">
  ...
  <a href="<?= BASE_URL ?>/student/browse_meals.php" class="btn">Order a Meal</a>
</div>
...
<div class="card mt-2">
  ...
  <p class="text-muted">As a <strong>Student</strong>, you are billed <strong>monthly</strong>.
     Your current month's total is <?= formatMoney($summary['monthly_amount']) ?>.
     <a href="<?= BASE_URL ?>/student/payments.php">View payment details &rarr;</a></p>
</div>

<div class="card mt-2">
  <div class="flex-between">
    <h3 class="mt-0">Recent Orders</h3>
    <a href="<?= BASE_URL ?>/student/my_orders.php">View all &rarr;</a>
  </div>
  <?php if (empty($recentOrders)): ?>
    <p class="empty-state">No orders yet. <a href="<?= BASE_URL ?>/student/browse_meals.php">Browse meals</a> to place your first order.</p>
  <?php else: ?>
    <table>
