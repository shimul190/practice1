      ...
      <tr>
        ...
        <td>
          <?php if (in_array($o['order_status'], ['accepted', 'preparing', 'out_for_delivery'], true)): ?>
            <a href="<?= BASE_URL ?>/student/track_delivery.php?order_id=<?= $o['order_id'] ?>" class="btn btn-sm btn-secondary">Track</a>
          <?php else: ?>
        ...
        <td>
          <?php if ($o['order_status'] === 'pending'): ?>
            <form method="POST" action="<?= BASE_URL ?>/student/cancel_order.php" style="display:inline;">
